...
export function Testimonials() {
  ...
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-[var(--color-gray-50)]">
      <div className="container-custom">
        ...
        <div className="relative mt-8 mx-auto max-w-3xl md:mt-10">
        ...
        {/* Stats */}
        <div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-center md:mt-12 md:gap-8">
          <div>
